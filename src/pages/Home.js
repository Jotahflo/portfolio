      ...
      <div id="sectionHome" className="bg-gray-800">
        <div className="container mx-auto pt-4 pb-8 grid grid-cols-1 md:grid-cols-2 items-center justify-items-center h-full md:h-screen w-screen">
          ...
          <div className="md:order-1">
            <p className="text-4xl text-white font-serif mb-2">Hello, I'm Juan</p>
            <p className="text-xl text-gray-400 font-medium mb-4">Frontend Developer</p>
            <p className="text-base text-gray-400 mb-4">
              I have great knowledge in the Area of Informatica and Years of Experience, working with Web and Mobile technologies, both in Frontend,
              and Backend.
            </p>
            <ActionButton
      ...
      <div id="sectionProjects">
        <div className="container mx-auto pt-12 lg:pt-24 pb-12 h-full md:h-screen">
          ...
          <div className="grid grid-cols-3 items-center text-center mb-10 md:mx-28 lg:mx-48 xl:mx-96">
            <p className="text-3xl font-serif">04+</p>
            <p className="text-3xl font-serif">06</p>
            <p className="text-3xl font-serif">03</p>
